...
class ActionDefaultAskAffirmation(Action):
    def name(self):
        return "action_default_ask_affirmation_in"
    ...
    async def run(self, dispatcher, tracker, domain):
        ...
        message = "क्षमा मांगना! आप क्या करना चाहते हैं?"
        # a mapping between intents and user friendly wordings
        intent_mappings = {
            "what_is": "लॉ गाइड क्या है?",
            "Agent": "बॉट का उपयोग?",
            "Help": "ग्राहक देखभाल",
        }
...
class ActionDefaultFallback(Action):
    def name(self) -> Text:
        return "action_default_fallback_in"

    async def run(self, dispatcher, tracker, domain):
        # tell the user they are being passed to a customer service agent
        message = "मुझे खेद है, मैं आपकी मदद नहीं कर सकता।"
        intent_mappings = {
            "Agent": "प्रतिनिधि"
        }
        buttons = [{
